...
import Banner from "../Images/nith-in-w1N1WmLDyHU-unsplash.jpg";

const About = () => {
  const handleClick = () => {
    window.open("AnkurResume.pdf", "_blank", "noreferrer");
  };
  const handleHacker = () => {
    window.open(
      "https://www.hackerrank.com/29813_mca1",
      "_blank",
      "noreferrer"
    );
  };
  const handleLeetcode = () => {
    window.open(
      "https://leetcode.com/ankur_sharma12345/",
      "_blank",
      "noreferrer"
    );
  };
    ...
    <Fragment>
      <Grid container className="aboutBody">
        <Box className="container">
          <Avatar
            className="avatar"
            sx={{ width: 480, height: 700, ml: 2 }}
            src={Banner}
            variant="square"
          ></Avatar>
          <Typography
            className="upperTypo"
            sx={{ color: "red", ml: 100, mt: -63, fontSize: "22px" }}
          >
            Hello, My name is
          </Typography>
          <Typography
          ...
          <Typography sx={{ ml: 64 }}>
            I have completed my Graduation from Brahmanand Degree College from
            2017 to 2020.I have Completed Masters in Computer Application(MCA)
            from session 2021 to 2023. Currently, I am working as a{" "}
            <span className="spanStyle">
              Software Developer at Opticodes Pvt. Ltd.
            </span>{" "}
            My hobbies are I love to play cricket amd and write something on
            social topics in my free time.
          </Typography>
          <Typography
            sx={{
              ml: 65,
          ...
          <Button onClick={handleHacker} sx={{ ml: 88, mt: -2 }}>
            <img
              className="img"
              src="https://repository-images.githubusercontent.com/231893793/cec60480-04a9-11eb-80c4-df7359d94047"
              alt="logo"
            />
          </Button>
          <Button sx={{ mt: -2, ml: 1.4 }} onClick={handleLeetcode}>
            <img
